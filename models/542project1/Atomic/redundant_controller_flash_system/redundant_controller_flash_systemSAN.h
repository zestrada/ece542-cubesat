#ifndef redundant_controller_flash_systemSAN_H_
#define redundant_controller_flash_systemSAN_H_
...
/*********************************************************************
               redundant_controller_flash_systemSAN Submodel Definition                   
*********************************************************************/

class redundant_controller_flash_systemSAN:public SANModel{
public:
...
public:
  ...
  redundant_controller_flash_systemSAN();
  ~redundant_controller_flash_systemSAN();
  void CustomInitialization();

  void assignPlacesToActivitiesInst();
  void assignPlacesToActivitiesTimed();
}; // end redundant_controller_flash_systemSAN

#endif // redundant_controller_flash_systemSAN_H_
