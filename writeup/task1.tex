...
Note that the MTBFs across different node types are very different: the MTBF for bank 4 memory errors varies from about 78 seconds (\fix{compute}) to about 98,000 seconds (\fix{lnet}).  There are a few possibilities for the cause of these results:
